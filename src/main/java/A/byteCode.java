...
public class byteCode {
    ...
    public static void assertGK(JSONObject currentKicks) {
        if (currentKicks == null) {
            Log.err("Invalid file - " + System.getProperty("user.home") + "/mind_db/gk.cn");
            Log.info("Automatically reset file");
            byteCode.save("gk", new JSONObject());
